...
A very common and useful operation on meshes is the mesh subdivision, needed to increase the mesh resolution. 
...
\begin{figure}
\begin{center}
  \includegraphics[width=0.98\textwidth]{./img/subdivision1d}
 \caption{Subdivision of a polyline in 2D case.}
 \label{fig:subdivision}
\end{center}
\end{figure}

Several mesh subdivision algorithms have been proposed; they differ on how the vertices of the new mesh are computed. 
The CGAL library provide a package \cite{cgal:s-ssm2-15b} to fully manage the subdivision process on manifold meshes and implements the most common algorithms: one-to-four midpoint, Catmull-Clark \cite{catmull1978recursively}, Doo-Sabin \cite{doo1978subdivision} and Loop \cite{loop1987smooth}.

\begin{figure}
 \begin{tabular}{cc}
  \includegraphics[width=0.45\textwidth]{./img/mesh-four}&
  \includegraphics[width=0.45\textwidth]{./img/mesh-catmull}\\
  one-to-four midpoint&Catmull-Clark\\
  \includegraphics[width=0.45\textwidth]{./img/mesh-doosabin}&
  \includegraphics[width=0.45\textwidth]{./img/mesh-loop}\\
  Doo-Sabin&Loop\\
 \end{tabular}
