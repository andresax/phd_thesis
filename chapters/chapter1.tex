...
In this case the geometrical entity created is no longer a simplicial complex, contains a sub mesh not visible from the outside and the normals of this submesh are not meaningful anymore.
...
\begin{figure}
 \begin{tabular}{cc}
  ...
  (a)&(b)
 \end{tabular}
 \caption{Example of self-intersection: a mesh evolves accorfing to the vector flow illustrated in (a); the outcome (b) is a self-intersecting mesh (blue lines).}
 \label{fig:selfint}
\end{figure}
