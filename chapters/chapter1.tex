...
\begin{thm}
  ...
  $\delta (O \cup \{ \Delta \})$ is 2-manifold if and only if  $(f,e,v) \in  \{(0, 0, 0),\allowbreak (3, 3, 1),\allowbreak (4, 5, 2),\allowbreak (4, 6, 3),\allowbreak (4, 6, 4)\}$
...
\begin{thm}
  ...
  $\delta (O \setminus \{ \Delta \})$ is 2-manifold if and only if  $(f,e,v) \in  \{(0, 0, 0),\allowbreak (3, 3, 1),\allowbreak (4, 5, 2),\allowbreak (4, 6, 3),\allowbreak (4, 6, 4)\}$
\end{thm}

\begin{figure}
 \begin{tabular}{ccccc}
  \includegraphics[width=0.3\columnwidth]{./img/maniftest01}&
  \includegraphics[width=0.3\columnwidth]{./img/notmanifold1}&
  \includegraphics[width=0.3\columnwidth]{./img/notmanifold2}\\
  (a) & (b) & (c)
 \end{tabular}
