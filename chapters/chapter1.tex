...
A more detailed descriptions are in \cite{botsch2010polygon,taubin1995signal,taubinygeometric,Sorkine}.
...
\]
Different discrete Laplacian-Beltrami operators $\bigtriangleup$ exist \cite{wardetzky2007discrete,Sorkine}, but the two most common are the uniform operator and the cotangent operator.
...
\[
\w_{ij} = \frac{1}{2} (cot(\alpha_{ij}) + cot(\beta_{ij})) \quad iff \quad v_i and v_j \text{shares one edge}
\]
