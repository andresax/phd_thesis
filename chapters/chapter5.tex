...
\begin{tabular}{cc}
\centering
\includegraphics[width=0.45\columnwidth]{./img//mooving_orig}&
\includegraphics[width=0.45\columnwidth]{./img//mooving_avg}\\
(a) & (b) \\
\includegraphics[width=0.45\columnwidth]{./img//mooving_weighted_avg}&
\includegraphics[width=0.45\columnwidth]{./img//mooving_min}\\ (c) & (d)\\
\end{tabular}
\end{center}
...
\centering
\begin{tabular}{cc}
\includegraphics[width = 0.45\textwidth]{./img//ExRec_cropped}&
\includegraphics[width = 0.45\textwidth]{./img//ExRec01_cropped}\\
\includegraphics[width = 0.45\textwidth]{./img//ExRec02_cropped}&
\includegraphics[width = 0.45\textwidth]{./img//ExRec05}\\
\end{tabular}
...
\centering
  \begin{tabular}{ccc}
    \centering
    \includegraphics[height=0.2\textwidth]{./img/results.pdf}&
    \includegraphics[height=0.2\textwidth]{./img/resultsTiming.pdf}&
    \includegraphics[height=0.18\textwidth]{./img/legenda}\\
    (a) Absolute errors (m).&
