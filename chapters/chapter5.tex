...
\begin{tabular}{cc}
\centering
\includegraphics[width=0.48\columnwidth]{./img//mooving_orig}&
\includegraphics[width=0.48\columnwidth]{./img//mooving_avg}\\
(a) & (b) \\
\includegraphics[width=0.48\columnwidth]{./img//mooving_weighted_avg}&
\includegraphics[width=0.48\columnwidth]{./img//mooving_min}\\ (c) & (d)\\
\end{tabular}
\end{center}
