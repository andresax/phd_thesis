...
In Section \ref{sec:manifold} we summarize the manifold reconstruction algorithm. 
...
% 
% 
% % In order to obtain a good initialization a mesh has to be manifold for further computations such as mesh optimization, and in the following experiments this property holds, thanks to the reconstruction method explained in Section \ref{sec:manifold}.
% 
