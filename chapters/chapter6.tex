...
\begin{figure}[tp]
  \centering
  \includegraphics[height=0.3\textwidth]{./img/ch-sweep/sweepMulti.pdf}
...
The mesh sweeping acts on pairs of cameras. 
In particular we apply the algorithm for each input camera, considered as reference.
...
Therefore the connectivity of the mesh is preserved \ie  and no self-intersections among facets has been induced. 
