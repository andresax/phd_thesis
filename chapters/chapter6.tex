...
In the proposed system (see Figure \ref{fig:overview}, we iteratively alternate manifold reconstruction and mesh sweeping.


The manifold is obtained as described in the previous chapter. First, by   \emph{Point Insertion}, \emph{Ray tracing} and \emph{Growing} we esimate an initial manifold of the whole scene
