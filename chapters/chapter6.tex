...
3D reconstructions from Sparse Points represent good candidates to initialize a surface evolution algorithm which is able to reconstructs the details of the scene. 
However in this chapter we show that a refinement step before mesh evolution, is able to improve the accuracy and the convergence of the variational framework which usually acts as the last reconstruction step. 
