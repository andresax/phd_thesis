...
\centering
\begin{tabular}{c}
\includegraphics[width=0.92\textwidth]{./img/poissonHist}\\
CMVS+ Poisson \\
\includegraphics[width=0.92\textwidth]{./img/realInitHist}\\
Initial manifold\\
\includegraphics[width=0.92\textwidth]{./img/realFinalHist}\\
Final manifold\\
\end{tabular}
