...
In the proposed system we iteratively alternate between manifold reconstruction and mesh sweeping (see Figure \ref{fig:overview}).
The manifold is obtained as described in the previous chapter. 
We estimate the initial mesh by applying the   \emph{Point Insertion}, \emph{Ray tracing} and \emph{Growing} steps
