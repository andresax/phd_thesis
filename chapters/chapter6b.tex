...
Moreover, we show hot to exploit laser data to detect moving object in the scene and mask them in the refinement process. 
...
We faced to big issue in order to provide an accurate reconstruction of the static map of the environment
...
Car detection
\subsection{Refinement and texturing without the moving objects}
