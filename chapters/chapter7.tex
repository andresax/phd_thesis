...
Whenever a manifold mesh that represents roughly the observed scene is available, we refine it in order to minimize the photo-metric error between pairwise camera induced by the reconstructed surface. 
