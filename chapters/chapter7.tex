...
We propose a fully automatic pipeline that integrates existing works on manifold reconstruction with an accurate surface evolving refinement step and a novel manifold-preserving mesh merging algorithm.
...
\centering
\begin{tabular}{cc}
\includegraphics[width=0.49\textwidth]{./img/ch-incr-dens/castle01}&
\includegraphics[width=0.49\textwidth]{./img/ch-incr-dens/castle02}\\
\includegraphics[width=0.49\textwidth]{./img/ch-incr-dens/castle03}&
\includegraphics[width=0.49\textwidth]{./img/ch-incr-dens/castle04}
\end{tabular}
\label{fig:castle}
...
\centering
\begin{tabular}{cc}
\includegraphics[width=0.49\textwidth]{./img/ch-incr-dens/castle05}&
\includegraphics[width=0.49\textwidth]{./img/ch-incr-dens/castle06}\\
\includegraphics[width=0.49\textwidth]{./img/ch-incr-dens/castle07}&
\includegraphics[width=0.49\textwidth]{./img/ch-incr-dens/castle08}\\
\includegraphics[width=0.49\textwidth]{./img/ch-incr-dens/castle12}&
\includegraphics[width=0.49\textwidth]{./img/ch-incr-dens/castle11}\\
(a)&(b)
\end{tabular}
...
\centering
\begin{tabular}{cc}
\includegraphics[width=0.49\textwidth]{./img/ch-incr-dens/castle09}&
\includegraphics[width=0.49\textwidth]{./img/ch-incr-dens/castle10}\\
(a)&(b)
\end{tabular}
\label{fig:detailcastle}
