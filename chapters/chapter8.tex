\chapter{Hybrid Visual and Laser 3D Reconstruction without moving objects}
\label{ch:laser}
...
\begin{figure}[tp]
 \centering
    \begin{tabular}{c}
    \includegraphics[width=0.48\textwidth]{originaFrame}\\
    \includegraphics[width=0.48\textwidth]{texuredRec}\\
 \end{tabular}
...
The previous steps output a downsampled lidar point cloud without the moving objects, and the position of the laser range finders in metric coordinates after the GICP registration.
