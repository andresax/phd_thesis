...
For each 2D $lxw$ bounding box we project the points along the direction parallel to the longest dimension between $l$ and $w$ (see Figure \ref{convHull}).
...
\begin{figure}[tp]
    ...
    \begin{tabular}{cc}
        ...
        (a)&(b)
    \end{tabular}
    \caption{3D points projected on the plane parallel to the longest box  dimension (a) that generate the car silhouette as convex hull(b)}
    \label{fig:convHull}
\end{figure}
