...
\begin{figure}[t]
\centering
\includegraphics[width=0.8\columnwidth]{depth-0129}
\caption{Example of a depthmap computed from a lidar point cloud.}
\label{fig:depth}
\end{figure}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.8\columnwidth]{points_result_on_mask}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.8\columnwidth]{graphres3}
